...
def save_best_record(test_info, file_path):
    ...
    # fo.write('cost train:'+str(test_info["cost"][-1])+'\n')
    # fo.write('roc auc:'+str(test_info["roc_AUC"][-1])+', ')
    # fo.write('max ap:'+str(test_info["max_ap"][-1])+',')
    # fo.write('recall:'+str(test_info["recall"][-1])+'\n')
    fo.close()