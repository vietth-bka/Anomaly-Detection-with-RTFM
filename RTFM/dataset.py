...
class Dataset(data.Dataset):
    def __init__(self, args, is_normal=True, transform=None, test_mode=False):
        ...
        if self.dataset == 'shanghai':
            ...
            print('--- Features ver2 ---')
            if test_mode:
                self.rgb_list_file = '/media/v100/DATA4/thviet/AnomalyDetection/I3D_extractor/ucf-test_v2.txt'#'list/ucf-i3d-test.list'
            else:
                self.rgb_list_file = '/media/v100/DATA4/thviet/AnomalyDetection/I3D_extractor/ucf-train_v2.txt'#'list/ucf-i3d.list'
...
class Infer(data.Dataset):
    def __init__(self, args, is_normal=True, transform=None, test_mode=False):
        ...
        self.tranform = transform
        self.test_mode = test_mode
        self.list = [args.video_feats] #glob.glob(args.video_feats+'/*.npy')
        print(self.list)
        # self._parse_list()
        self.num_frame = 0
        self.labels = None
    ...
    def __getitem__(self, index):
        ...
        if self.test_mode:
            ...
            return divided_features, self.labels
