...
parser.add_argument('--lr', type=float, default=0.01, help='learning rates')
...
parser.add_argument('--scores_file', type=str, default='scores/score_VietDuy_ori.npy', help='path to the video scores')