...
### Run
```bash
python main.py --datasetpath=demovideos/ --outputpath=output
```
After running the above instruction, file .npy will be saved at output, which used as the input of [***RTFM***](../RTFM).
